...
var ytComponent=function(t){this.player,this.replay=!1,this.container=t.container,this.width=t.width,this.height=t.height,this.videoId=t.videoId,this.tracker=t.tracker,this.autoplay=t.autoplay||!1,this.realTime,this.playTimeDone=[],this.loadAPI()};ytComponent.prototype.curry=function(t,e){e=e||window;var a=arguments;return function(){for(var i=[],r=0;r<arguments.length;r++)i.push(arguments[r]);for(var n=2;n<a.length;n++)i.push(a[n]);return t.apply(e,i)}},ytComponent.prototype.loadAPI=function(){var t=document.createElement("script");t.src="https://www.youtube.com/iframe_api";var e=document.getElementsByTagName("script")[0];e.parentNode.insertBefore(t,e)},ytComponent.prototype.loadVideo=function(){this.player=new YT.Player(this.container,{width:this.width,height:this.height,videoId:this.videoId,events:{onReady:this.curry(this.onPlayerReady,this),onStateChange:this.curry(this.onPlayerStateChange,this)}})},ytComponent.prototype.onPlayerReady=function(t,e){this.autoplay&&t.target.playVideo()},ytComponent.prototype.onPlayerStateChange=function(t){-1==t.data?this.tracker("E","unstarted"):0==t.data?(this.replay=!0,this.tracker("E","end")):1==t.data?this.replay?this.tracker("E","replay"):(this.realTime=setInterval(this.curry(this.videoPlayLength,this),100),console.log(this.tracker),this.tracker("E","rexona_video"),console.log("rexona_video"),this.tracker("E","playing")):2==t.data&&(clearInterval(this.realTime),this.tracker("E","paused"))},ytComponent.prototype.videoPlayLength=function(){if(this.replay)return void clearInterval(this.realTime);var t=this.player.getDuration(),e=this.player.getCurrentTime(),a=100*(Math.round(e/t*4)/4).toFixed(2);25==a&&-1==this.playTimeDone.indexOf(a)?this.tracker("E","play_25"):50==a&&-1==this.playTimeDone.indexOf(a)?this.tracker("E","play_50"):75==a&&-1==this.playTimeDone.indexOf(a)&&this.tracker("E","play_75"),this.playTimeDone.push(a);var i=0==this.player.getPlayerState();i&&clearInterval(this.realTime)};
